...
<div class="card-inner">
    <a href="#" data-toggle="modal" data-target="#add" class="btn btn-primary">Add City</a>
    <p></p>
...
<td>
    <a data-toggle="modal" data-target="#deleteid" onclick="delid(<?php echo $row['cid']?>)" class="btn btn-danger">Delete</a>
    <a data-toggle="modal" data-target="#updateid" onclick="upid()" class="btn btn-primary">Update</a>
        ...
        <div class="modal-header">
          ...
          <div class="modal-body">
              ...
              <select class="form-control form-select-sm">
                  ...
                  <option value="<?php echo $row['did']?>"><?php echo $row['district']?></option>
                  <?php }?>
              </select>
              <label>City</label>
            <input type="text" name="city_name" id="city_name" class="form-control form-control-sm"/>
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-header">
          ...
          <div class="modal-body">
              ...
              <label>City</label>
            <input type="text" name="city_name" id="u_city_name" class="form-control form-control-sm"/>
...
function delid(id){
    //alert(id)
    $('#del_id').val(id);
    //$('#del_id').val(id);// Return to Delete Modal input 
    
}

function upid(id,idc){
    $('#up_id').val(id);
    $('#u_city_name').val(idc);
   }
...
function update(){
    ...
    var token=$('#u_token').val()
    $.ajax({
        url:'city_update',
        method:'POST',
        data:{id:id,city_name:city_name,_token:token},
        success:function(){
         window.location.assign('ct');   
        }
    })
